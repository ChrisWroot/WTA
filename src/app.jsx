...
<style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Mono:wght@300;400;500&family=Bebas+Neue&display=swap'); *{box-sizing:border-box;margin:0;padding:0;} ::-webkit-scrollbar{width:4px;height:4px;} ::-webkit-scrollbar-track{background:#080c15;} ::-webkit-scrollbar-thumb{background:#1e3055;border-radius:2px;} button:focus{outline:none;} select{background:#0d1525;color:#c8d8f0;border:1px solid #1a2a45;border-radius:6px;padding:5px 8px;font-family:inherit;font-size:10px;cursor:pointer;} tr:hover td{background:#0f1d35!important;}`}</style>
